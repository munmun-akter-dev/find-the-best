  ...
  return (
    <>
      <div className="bg-[#F8FAFC]">
        <div className="container lg:pt-[128px]  md:pt-[45px] md:p-[10px] md:px-[50px]">
          <div className="grid grid-cols-12 ">

            <div className="lg:col-span-4 md:col-span-3 mb-[46px]  ">
              ...
              <div className="svg_parent flex justify-start items-center mt-[48px] md:hidden  ">
                  ...
                  <fieldset className="">
                    ...
                    <div className="flex gap-[10px] mt-[28px] md:flex-wrap">
                      <input
                        ...
                        className="input input-bordered text-[#71717A] font-Urbanist lg:text-[16px] md:text-[14px] font-normal leading-[16px] w-[244px] h-[45px]" />
          ...
          <hr className="text-[#CBD5E1] h-[1px] lg:mt-[80px] md:mt-[30px]" />
