...
const Los = () => {
  return (
    <>
      <div className="container bg-[#09090B]">
        <div className="los_parent flex justify-center items-center pt-[126px]">
          <div className="card bg-[#1F1F21] w-[770px] h-[345px] shadow-xl p-[80px] rounded-[8px]">

            <div className="card-body items-center text-center ">
              <h2 className="card-title text-white font-Fraunces text-[48px] font-normal leading-[48px] pb-[20px]">Los Geht’s</h2>
              ...
              <div className="flex justify-center items-center  gap-3">
                <div className="flex justify-center items-center ">
                  <input id="default-radio-1 " type="radio" value="" name="default-radio" className="w-4 h-4 text-ye border-[#E4E4E7] " />
