          ...
          <div className="los_parent flex justify-center items-center  lg:pt-[126px] md:pt-[40px] md:pb-[40px]">
            <div className="card bg-[#1F1F21] w-full md:max-w-[426px]   lg:max-w-[770px]  shadow-xl p-[80px] md:px-[80px] md:py-[48px] rounded-[8px]">
              ...
              <div className="card-body items-center text-center ">
                <h2 className="card-title text-white font-Fraunces lg:text-[48px] md:text-[30px] font-normal leading-[48px] pb-[20px]">{los.title}</h2>
                ...
                <div className="radio_parent flex justify-center items-center gap-4">
                  <div className="flex justify-center items-center gap-2">
                    ...
                    <input type="radio" id="male" name="radio-8" className="radio radio-error border-white  " />
                    <label className="text-white font-Urbanist text-[16px] font-normal leading-[16px]" htmlFor="male">Male</label>
                  </div>
                  <div className="flex justify-center items-center gap-2">

                    <input type="radio" id="female" name="radio-8" className="radio radio-error" defaultChecked />
                    <label className="text-white font-Urbanist text-[16px] font-normal leading-[16px]" htmlFor="female">Female</label>
                ...
                <div className="flex justify-center items-center mt-[30px] ">
                  ...
                  <button className=" yellow_btn flex w-[195px] h-[54px] p-[10px] justify-center items-center  bg-[#F7941D]    rounded-[4px]">

                    <svg className="mr-[10px]" xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 23 22" fill="none">
                    ...
                    <span className="text-white font-Urbanist text-[16px] font-normal leading-[24px] "> Upload Image</span></button>
